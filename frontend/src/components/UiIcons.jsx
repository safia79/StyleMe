...
const PATHS = {
  ...
  heart: (
    <path d="M12 20s-7-4.35-9.4-8.05C.7 8.7 2.3 5 6.1 5c1.9 0 3.3 1.15 3.9 2.2C10.6 6.15 12 5 13.9 5c3.8 0 5.4 3.7 3.5 6.95C19 15.65 12 20 12 20z" />
  ),
  heartFilled: (
    <path
      d="M12 20s-7-4.35-9.4-8.05C.7 8.7 2.3 5 6.1 5c1.9 0 3.3 1.15 3.9 2.2C10.6 6.15 12 5 13.9 5c3.8 0 5.4 3.7 3.5 6.95C19 15.65 12 20 12 20z"
      fill="currentColor"
    />
  ),
};
